-- Seed catalyst events for the 50 tracked companies
-- Uses the predictable UUIDs from seed_companies
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000005', 'BCEAO licence grant', 'regulatory', '2026-03-28', 'high', 'positive', 'Final approval expected at Q1 board meeting'),
